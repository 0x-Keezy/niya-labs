...
export class VRMLookAtSmoother extends VRMLookAt {
  /** スムージング用の係数 - higher = more damping for smoother transitions */
  public smoothFactor = 7.0;

  /** ユーザ向きに向く限界の角度 in degree - eyes track within this range */
  public userLimitAngle = 30.0;
  ...
  public update(delta: number): void {
    if (this.target && this.autoUpdate) {
      ...
      if (this.userTarget) {
        ...
        // yawFrame / pitchFrame に結果を代入 - amplified for more visible movement
        ...
        // Minimal head movement - eyes do most of the tracking work
        head.quaternion.slerp(_quatA, 0.08);
