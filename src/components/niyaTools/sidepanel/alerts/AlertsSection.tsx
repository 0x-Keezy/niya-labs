...
import { webNotify, requestNotificationPermission } from '../../lib/webAdapter';
...
export default function AlertsSection({
  ...
  useEffect(() => {
    ...
    if (changed) {
      ...
      // Fire browser notification for newly triggered rules. If the user
      // hasn't granted permission yet, `webNotify` silently no-ops — the
      // rule still shows as TRIGGERED in the UI so no signal is lost.
