  ...
  if (!userAddress) {
    return (
      <form
        ...
        className="flex max-w-full md:max-w-[200px] flex-col items-end gap-1"
      >
        <div className="flex items-center gap-1">
          <input
            ...
            className="w-full md:w-[140px] rounded-lg border border-niya-border bg-niya-bg px-2 py-1 font-mono text-[10px] text-niya-ink placeholder:text-niya-ink-2 focus:border-niya-gold/50 focus:outline-none disabled:opacity-50"
          />
          <button
            type="submit"
